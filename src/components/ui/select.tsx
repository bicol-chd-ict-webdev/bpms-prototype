...
function Select(props: NativeSelectProps | RadixSelectProps) {
  if ("onChange" in props) {
    return <select data-slot="select" {...(props as NativeSelectProps)} />
  }

  return <SelectPrimitive.Root data-slot="select" {...(props as RadixSelectProps)} />
}
